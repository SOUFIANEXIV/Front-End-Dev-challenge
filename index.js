...
function displayCandidates() {
  ...
  candidatesToDisplay.forEach((candidate) => {
    allCondidates.innerHTML += `
    <div class="  flex flex-wrap items-center bg-white  justify-between  pt-6 pl-4 border-b pb-6  ">
...
function displayPaginationControls() {
  ...
  let paginationControls = `
    <div class="pagination-controls  px-2 flex justify-between mb-5 mt-2">
